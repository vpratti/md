...
app.factory('authService', [
    '$http', '$q', 'localStorageService', 'ngAuthSettings', 'messaging', 'vcAppConstants',
    function($http, $q, localStorageService, ngAuthSettings, messaging, vcAppConstants) {
        ...
        var saveAnonymousRegistration = function(registration) {
            return $http.post(ngAuthSettings.apiServiceBaseUri + 'api/account/RegisterAnonymous', registration).then(function(response) {
                return response;
            });
        ...
        authServiceFactory.saveAnonymousRegistration = saveAnonymousRegistration;
